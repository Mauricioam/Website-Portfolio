...
function CvIcon({ hpx, wpx}){
    ...
    return (
        <a  className='hover:cursor-pointer' href="https://drive.google.com/file/d/1puHsZ1ufWOtEVJqpWbo1nlKj1r2ksNui/view" target={"_blank"}   onMouseEnter={()=>setHover(!hover)} onMouseLeave={()=>setHover(!hover)}>
