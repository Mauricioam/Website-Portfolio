...
function CvIcon({ hpx, wpx}){
    ...
    return (
        <a  className='hover:cursor-pointer' href="https://drive.google.com/file/d/1EYgkb4UNAcunKJCyqJ23BMqMLcmp2Ssb/view?usp=share_link" target={"_blank"}   onMouseEnter={()=>setHover(!hover)} onMouseLeave={()=>setHover(!hover)}>
