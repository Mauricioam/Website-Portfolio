...
function CvIcon({ hpx, wpx}){
    ...
    return (
        <a  className='hover:cursor-pointer' href="https://drive.google.com/file/d/1NONMV1Dcnb5CDYj5qfhGWC94ow3gtR4T/view?usp=share_link" target={"_blank"}   onMouseEnter={()=>setHover(!hover)} onMouseLeave={()=>setHover(!hover)}>
