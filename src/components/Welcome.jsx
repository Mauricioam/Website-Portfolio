  ...
  return (
    ...
    <div className=' flex items-center min-h-[29rem]  ' >
        ...
        <div className='lg:flex lg:flex-col lg:gap-16 flex flex-col gap-8 m-auto '>
          <div className='flex'>
          <button onMouseEnter={()=>setOnMouseEffect(true)} className={` z-0 hover:cursor-loading relative text-secondary lg:text-7xl text-3xl font-bold before:content-["MAURICIO/MURDOCH"] before:text-error before:absolute ${onMouseEffect && "before:-translate-x-2 before:-translate-y-2"}  }`}>MAURICIO/MURDOCH</button>
          
          </div>
        <h1 className='md:text-5xl text-3xl  text-secondary font-extrabold'>Front-End React Developer</h1>
