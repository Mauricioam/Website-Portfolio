...
const [press, setPress] = useState(false);
  ...
  return (
    <button onClick={()=>setPress(!press)} className={`relative font-bold text-lg m-1 hover:text-primary hover:transition-colors ${press ? "text-dark_shade hover:text-slate-100": "text-black"}`}>
